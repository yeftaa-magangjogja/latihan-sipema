                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="flex items-center">
                                            <ul class="text-sm">
                                                ...
                                                {{-- <!-- Tombol Edit -->
                                                <a href="{{ route('mhs.edit', $mahasiswa->id) }}"
                                                    class="flex items-center py-2 px-4 text-yellow-500 hover:bg-yellow-100 dark:text-yellow-200 dark:hover:bg-yellow-600 dark:hover:text-white rounded-lg transition duration-150 ease-in-out">
                                                    <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                        <path
                                                            d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
